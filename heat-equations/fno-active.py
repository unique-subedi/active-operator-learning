...
trainset_active_torch = []
for s in trainset_active:
        trainset_active_torch.append(  {
...
for sample_size in sample_sizes:
    ...
    # Create DataLoaders
    trainloader = DataLoader(trainset_active_torch[:sample_size], batch_size=15, shuffle=True)
    ...
    FNO_active_losses.append(test_loss / len(testdataset))
    print(f"Test Loss for {sample_size} samples: {FNO_active_losses[-1]}")



plt.plot(sample_sizes, FNO_active_losses)
